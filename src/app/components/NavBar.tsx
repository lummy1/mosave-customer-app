  ...
  const closeDropdownPopover = () => {
    ...
    return (
            ...
            <div className="antialiased bg-gray-50 dark:bg-gray-900">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            >
                                <div className="py-3 px-4">
                                    ...
                                    >Neil Sims</span>
                                    <span
                                        className="block text-sm text-gray-900 truncate dark:text-white">name@moloyal.com</span>
                                </div>
                                <ul
                ...
                <aside id="drawer-navigation" aria-label="Sidenav" className="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700">
