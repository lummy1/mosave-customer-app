...
const ThemeToggle = () => {
  ...
  const ThemeButton = () => {
    return (
      ...
      >
        {theme === "light" ? <BsBrightnessHigh size={20} /> : theme === "dark" ? <BsMoon size={20} /> : <BsMoonStars size={20} />}
      </button>
    );
  };
  return (
    <>
      {isMounted && (
        ...
        //    <ThemeButton />
        // </Tooltip>
        <Dropdown inline label={<span>{theme === "light" ? <BsBrightnessHigh size={20} /> : theme === "dark" ? <BsMoon size={20} /> : <BsMoonStars size={20} />}</span> }>
