            ...
            <div className="mb-5">
              ...
              <div className="grid grid-cols-1 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
                ...
                <div className="col-span-2">
                  ...
                  {/* Start block */}
                  <section className="p-4 mb-4 lg:space-y-6 space bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                    <div className="px-4 py-2 mx-auto max-w-screen-2xl">
                      <div className="bg-white dark:bg-gray-800 relative overflow-hidden">
                        <div className="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between py-4 dark:border-gray-700">
